...
export const eu: PatternPack = {
  ...
  name: "European Union",
  patterns: [
    // BIC first — tighter format (11 or 8 alphanumerics, specific shape). VAT's permissive [A-Z0-9]{8,12} otherwise eats it.
...
export const au: PatternPack = {
  ...
  name: "Australia",
  patterns: [
    // ABN (11 digits) before TFN (9 digits) — prevents TFN from gobbling the leading 9 digits of ABN
